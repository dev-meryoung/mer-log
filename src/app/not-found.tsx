...
const NotFound = () => (
  <div className='w-full flex flex-col items-center px-10 py-60 gap-1.5 rounded-lg select-none bg-white shadow-md dark:bg-darkActive'>
    <h1 className='font-recipekorea text-7xl md:text-8xl dark:text-text-dark'>
      404
    </h1>
    ...
    <Link
      href='/'
      className='text-sm md:text-base px-2.5 py-1.5 mt-2.5 rounded-md border-2 border-text-light dark:border-text-dark dark:text-text-dark'
    >
      메인으로 이동
    </Link>
  </div>
